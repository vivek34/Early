...
public class SongInfo {
    ...
    public SongInfo(ImageView imageView, String songName, String session, String likes, String time)
    {
        this.song_image = imageView;
        this.SongName = songName;
        this.session = session;
        this.likes = likes;
        this.time = time;
    }
    public SongInfo(ImageView imageView, String songName, String session, String time)
    {
        this.song_image = imageView;
        this.SongName = songName;
        this.session = session;
    ...
    public SongInfo(String songName, String session, String time)
    {
        this.SongName = songName;
        this.session = session;
        this.time = time;
