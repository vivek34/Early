...
import com.example.vivekpatel.homepage.Activities.Recent;
...
public class RecentAdapter extends RecyclerView.Adapter<RecentAdapter.ItemRowHolder> {
    ...
    public RecentAdapter(Context context, ArrayList<SectionDataModel> dataList) {
        this.dataList = dataList;
        this.mContext = (MainScreen) context;
    }
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        itemRowHolder.btnMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext,Recent.class));
            }
        });
